...
inline void put_pixel(uint16_t x, uint16_t y, uint32_t color) {
...
inline void draw_rect(uint16_t x, uint16_t y, uint16_t width, uint16_t height, uint32_t color) {
...
inline void draw_line(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2, uint32_t color) {
    int dx =  (x2 - x1);
    int dy = -(y2 - y1);
    int sx = x1 < x2 ? 1 : -1;
    int sy = y1 < y2 ? 1 : -1;
...
inline uint32_t vga_to_rgb(uint8_t vga_color) {
